...
MMS2->AddMaterial(Fe2O3, 9.3*perCent); //Used Oltaris for this formula
...
G4Material*shape3_mat = new G4Material("Brick", 1.622*g/cm3, 2);
shape3_mat->AddMaterial(PE, 10*perCent);
shape3_mat->AddMaterial(MMS2, 90*perCent); //p27 Sargent C6H10O2 formulas
...
*/
  ...
  G4ThreeVector pos2 = G4ThreeVector(0*m, -20*m, 0*m);
  // Trap shape       
